...
class UserItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_item" do
    assert_difference('UserItem.count') do
      post user_items_url, params: { user_item: { amount: @user_item.amount, itemcost: @user_item.itemcost, itemname: @user_item.itemname, quantity: @user_item.quantity, shortdescription: @user_item.shortdescription, storename: @user_item.storename } }
    end
  ...
  test "should update user_item" do
    patch user_item_url(@user_item), params: { user_item: { amount: @user_item.amount, itemcost: @user_item.itemcost, itemname: @user_item.itemname, quantity: @user_item.quantity, shortdescription: @user_item.shortdescription, storename: @user_item.storename } }
