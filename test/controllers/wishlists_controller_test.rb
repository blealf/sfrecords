...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { amount: @wishlist.amount, comment: @wishlist.comment, itemcost: @wishlist.itemcost, itemname: @wishlist.itemname, quantity: @wishlist.quantity } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { amount: @wishlist.amount, comment: @wishlist.comment, itemcost: @wishlist.itemcost, itemname: @wishlist.itemname, quantity: @wishlist.quantity } }
